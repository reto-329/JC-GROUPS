...
router.get('/contacts', requireAdminLogin, AdminPagesController.getContacts);
router.get('/api/contacts/:id', requireAdminLogin, AdminPagesController.getContact);
router.put('/api/contacts/:id/status', requireAdminLogin, AdminPagesController.updateContactStatus);
router.delete('/api/contacts/:id', requireAdminLogin, AdminPagesController.deleteContact);
